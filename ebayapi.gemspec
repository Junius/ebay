Gem::Specification.new do |s|
  ...
  s.authors = ["Cody Fauser", "Andrew Nesbitt"]
  s.date = %q{2010-10-13}
  s.description = %q{Ruby client for the eBay unified schema XML API}
  ...
  s.files = [
    "CHANGELOG",
     ...
     "lib/ebay/types/integrated_merchant_credit_card_info.rb",
  ...
  s.homepage = %q{http://ebayapi.rubyforge.org}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{Ruby client for the eBay unified schema XML API}
  s.test_files = [
    "test/credentials.rb",
     "test/helper.rb",
     "test/http_mock.rb",
